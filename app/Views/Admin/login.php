...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= base_url('template/lte/plugins/iCheck/square/blue.css')?>">
...
<div class="login-box">
  <div class="text-center">
    <img width="120px" src="<?= base_url('assets/img/smk.png') ?>" alt="">
    <h4><b>SMK AL-KHOERIYAH KOTA TASIKMALAYA</b></h4>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?= base_url('template/lte/plugins/iCheck/icheck.min.js')?>"></script>
<script>
  $(function () {
    $('input').iCheck({
